...
% Measured data file
fileTDMS = 'unb147_p2_1gf1p1.tdms';  %Adotar como referencia baixa
fileTDMS = 'unb148_p2_1gf1p2.tdms'; %Adotar como referencia alta
fileTDMS = 'unb182_p2_0gf1xx.tdms'; % Usado como valor residual
fileTDMS = 'unb186_p2_1gf1p3.tdms'; % Usado na apresentação
...
yVT = ConvertedData.Data.MeasuredData(1,bset(2)).Data';
...
speedc = 480/60; %[rps] (0 [rps] if no compensation)

% matrix cascade 
matrix1 = plotspectrumtest(iKT,yVT,xVT,delta_t,speed,speedc); %[adm],[m],[m],[s],[rps],[rps]
...
L=length(xVT);
t=(0:L-1)*delta_t;
%plotpresentation(xVT, yVT, t, delta_t, speed'); %[m],[m], [s], [rps]
