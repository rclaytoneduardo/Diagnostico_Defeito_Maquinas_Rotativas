...
for disk_node = [7 9 11 13 15];
numsim=50;

a0=1.02*0.65; b0=1.02*1.05; r0 = a0 + (b0-a0).*rand(numsim,1); % damping_factor variance
...
a4=0.006; b4=0.02; r4 = a4 + (b4-a4).*rand(numsim,1); % Mis
...
% Misalignment force
model.misforce = [1 r4(i)]; % [Misalig_Type(1->angular) teta(degrees)]
...
%  Matrix of Feature 
databuilder(fail,matrix,disk_node,r0(i),r1(i),r2(i),r3(i),r4(i));
