...
%digitDatasetPath = fullfile('C:\Users\Clayton\Documents\Mestrado_ITA\Dissertacao\2Modelagem Matlab\07_PCADISCRIMINANT\Data');
...
%digitDatasetPathexp = fullfile('C:\Users\Clayton\Documents\Mestrado_ITA\Dissertacao\2Modelagem Matlab\07_PCADISCRIMINANT\Dataexp');
...
for i=1:nrow
   ...
   %matrix_i.matrix = matrix_i.matrix(1:28,:);
...
for i=1:nrow
   ...
   %matrix2_i.matrix = matrix2_i.matrix(1:28,:);
